...
* TID=100 krad: Bilayer oxide trapped charge
Physics (Material="Al2O3") {
    Traps ((FixedCharge SpatialShape=Uniform Conc=2.5e17))
}
Physics (Material="HfO2") {
    Traps ((FixedCharge SpatialShape=Uniform Conc=1.5e18))
}

* CNT/Al2O3 interface: Donor + Acceptor states
Physics (MaterialInterface="CNT_thin_film/Al2O3") {
    Traps (
        (FixedCharge SpatialShape=Uniform Conc=1.1e11)
        (Donor Conc=5.5e10 EnergyMid=0.0 EnergySig=0.1
            eXsection=1e-15 hXsection=1e-15 fromMidBandGap)
        (Acceptor Conc=5.5e10 EnergyMid=0.0 EnergySig=0.1
            eXsection=1e-15 hXsection=1e-15 fromMidBandGap)
    )
}
