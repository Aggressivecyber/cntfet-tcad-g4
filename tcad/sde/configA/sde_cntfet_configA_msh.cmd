...
Placements {
	...
	Refinement "Place.GateSiO2" {
		Reference = "Ref.GateSiO2"
		RefineWindow = region ["R.GateSiO2"]
	}
	...
	Refinement "Place.GateEdgeS" {
		...
		RefineWindow = Rectangle [(0 -0.018) (0.010745 -0.014)]
	}
	Refinement "Place.GateEdgeD" {
		Reference = "Ref.GateEdgeD"
		RefineWindow = Rectangle [(0 0.014) (0.010745 0.018)]
	}
}

AxisAligned {
	xCuts=(0.000745, 0.010745, 0.015745)
