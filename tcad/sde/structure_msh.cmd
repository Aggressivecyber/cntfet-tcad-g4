...
Definitions {
	...
	Refinement "Ref.Al2O3" {
		MaxElementSize = ( 0.0005 0.001 )
		MinElementSize = ( 1e-05 1e-05 )
	}
	Refinement "Ref.HfO2" {
...
Placements {
	...
	Refinement "Place.Al2O3" {
		Reference = "Ref.Al2O3"
		RefineWindow = region ["R.Al2O3"]
	}
	Refinement "Place.HfO2" {
		Reference = "Ref.HfO2"
		RefineWindow = region ["R.HfO2"]
	}
	...
	Refinement "Place.GateEdgeS" {
		...
		RefineWindow = Rectangle [(0 -0.018) (0.002745 -0.014)]
	}
	Refinement "Place.GateEdgeD" {
		Reference = "Ref.GateEdgeD"
		RefineWindow = Rectangle [(0 0.014) (0.002745 0.018)]
	}
}

AxisAligned {
	xCuts=(0.000745, 0.002745, 0.008745, 0.013745)
